                      ...
                      <div className="flex flex-wrap gap-4">
                        ...
                        >
                          <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 mr-1.5 text-[#872EC4]">
                            ...
                            <path fill="white" d="M10 2.75c4.978 0 9.028 4.05 9.028 9.028 0 4.978-4.05 9.028-9.028 9.028-4.978 0-9.028-4.05-9.028-9.028C.972 6.8 5.022 2.75 10 2.75z"/>
                            <path fill="currentColor" d="M13.195 16.604c-.102.151-.271.243-.453.243-.119 0-.238-.039-.336-.118l-4.031-3.258c-.108-.087-.17-.216-.17-.354V7.608c0-.248.201-.449.449-.449h2.694c.248 0 .449.201.449.449v4.616l3.354 2.711c.2.162.231.456.069.656l-.025.032z"/>
                          </svg>
