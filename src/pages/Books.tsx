...
const Books: React.FC = () => {
  const books = [
    ...
    },
    {
      ...
      description: "The Last Action Heroes opens in May 1990 in Cannes, with Arnold Schwarzenegger and Sylvester Stallone waltzing together, cheered on by a crowd of famous faces. After years of bitter combat - Stallone once threw a bowl of flowers at Schwarzenegger's head, and the body count in Schwarzenegger's Commando was increased so the film would "have a bigger dick than Rambo" - the world's biggest action stars have at last made peace. This chronicle of the golden age of the action movie not only charts Stallone and Schwarzenegger's carnage-packed journey from enmity to friendship, against the backdrop of Reagan's America and the Cold War, but reveals untold stories of the colourful characters who ascended in their wake: high-kickers Chuck Norris and Jackie Chan, glowering tough guys Dolph Lundgren and Steven Seagal, and quipping troublemakers Jean-Claude Van Damme and Bruce Willis. Drawing on candid interviews with the action stars themselves, plus their collaborators, friends, and foes, The Last Action Heroes is a no-holds-barred account of a period in Hollywood history when there were no limits to the heights of fame these men achieved, or to the mayhem they wrought, on-screen and off.",
      year: "2023",
