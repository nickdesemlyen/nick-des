  ...
  const books = [
    {
      ...
      description: "Wild and Crazy Guys is the larger-than-life story of the much-loved Hollywood comedy stars that ruled the 1980s.\n\nAs well as delving behind the scenes of classic movies such as Ghostbusters, Beverly Hills Cop, The Blues Brothers, Trading Places and dozens more, it chronicles the off-screen, larger-than-life antics of John Belushi, Dan Aykroyd, Bill Murray, Eddie Murphy, Chevy Chase, Steve Martin, John Candy et al. It's got drugs, sex, punch-ups, webbed toes and Bill Murray being pushed into a swimming pool by Hunter S Thompson, while tied to a lawn chair. Based on candid interviews from the stars themselves, as well as those who entered their orbit, it reveals the hidden history behind the most fertile period ever for screen comedy.",
      year: "2019",
